-- Add distribuidor column to participants table
ALTER TABLE public.participants ADD COLUMN IF NOT EXISTS distribuidor text;

-- Update RPC to count participants from participants table grouped by distribuidor

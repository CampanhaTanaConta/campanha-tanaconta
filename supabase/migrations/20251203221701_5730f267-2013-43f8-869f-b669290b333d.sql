-- Update get_admin_dashboard_data to include all distributors and "Sem Registro" category
...
BEGIN
  ...
  -- Distributors: Include ALL distributors and "Sem Registro" category
  -- Count DISTINCT participants per distributor
  ...
  -- Get all distributors from wallet (including nulls as "Sem Registro")

-- Create function to get aggregated dashboard data for admins
-- This function bypasses RLS to show all participants and distributors data
...
BEGIN
  ...
  -- Aggregate distributors data (by representante)

-- Drop and recreate get_admin_dashboard_data to return ORIGINAL transaction values for global KPIs
...
BEGIN
  ...
  -- Distributors: Fetch from wallet table
  ...
  -- Global KPIs: Return ORIGINAL transactions (NO DIVISION for global metrics)
